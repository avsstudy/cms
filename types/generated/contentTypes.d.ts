...
export interface ApiAboutPageAboutPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.Component<'shared.ck-editor-text', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    page_type: Schema.Attribute.Enumeration<
      ['privacy_policy', 'public_offer', 'returns_policy', 'partial_purchase']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAsideBannerAsideBanner extends Struct.CollectionTypeSchema {
  collectionName: 'aside_banners';
  info: {
    displayName: 'Aside_banner';
    pluralName: 'aside-banners';
    singularName: 'aside-banner';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'course_recording'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiHandbookHandbook extends Struct.CollectionTypeSchema {
...
export interface ApiStudySessionStudySession
  ...
  attributes: {
    ...
    session_admin_status: Schema.Attribute.Enumeration<
      ['not_opened', 'chat', 'stream_recording', 'live']
    > &
...
export interface ApiTopicGroupTopicGroup extends Struct.CollectionTypeSchema {
  collectionName: 'topic_groups';
  info: {
    displayName: 'Topic_Group';
    pluralName: 'topic-groups';
    singularName: 'topic-group';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::aside-banner.aside-banner': ApiAsideBannerAsideBanner;
